<?php
	...
	//	Funtion untuk menghitung tagihan awal
	...
	//	Variabel $cabang berisi data kota lokasi cabang restoran dalam bentuk array.
		$cabang = array("Harmoni" => "Harmoni", "Sarinah" => "Sarinah", "Grogol" => "Grogol", "Senayan" => "Senayan", "Pluit" => "Pluit", "Cempaka" => "Cempaka");
